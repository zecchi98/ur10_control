...
def move_robot_to_cube_pose():
    ...
    joint_vet[0]=transformation_library.grad_to_rad(-62)
    joint_vet[1]=transformation_library.grad_to_rad(-82)
    joint_vet[2]=transformation_library.grad_to_rad(116)
    joint_vet[3]=transformation_library.grad_to_rad(-29)
    joint_vet[4]=transformation_library.grad_to_rad(-62)
    joint_vet[5]=transformation_library.grad_to_rad(-2)
